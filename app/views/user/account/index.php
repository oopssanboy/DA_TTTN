    ...
    <div class="account-layout row">
        ...
        <div class="account-sidebar">
            <div class="account-info-box card-box text-center">
                <form action="/doi-avatar" method="POST" enctype="multipart/form-data"
                    style="text-align: center; margin-bottom: 20px;">
                    <div class="user-avatar-wrapper account-page-avatar">
                        <img src="<?php echo $avatar; ?>" alt="Avatar" class="user-avatar">
                    </div>
                    <div style="margin-top: 15px;">
                        <input type="file" name="avatar_file" id="avatar_file" accept="image/*" required
                            style="display: none;" onchange="this.form.submit()">

                        <label for="avatar_file" class="btn-primary"
                            style="cursor: pointer; padding: 8px 20px; border-radius: 20px; display: inline-block; font-size: 13px;">
            ...
            <ul class="account-menu-list">
                <li><a href="/tai-khoan?tab=info" class="<?php echo ($tab == 'info') ? 'active' : ''; ?>"><i
                            class="fa-solid fa-user"></i> Thông tin tài khoản</a></li>
                <li><a href="/tai-khoan?tab=change_info"
                        class="<?php echo ($tab == 'change_info') ? 'active' : ''; ?>"><i
                            class="fa-solid fa-pen-to-square"></i> Cập nhật thông tin</a></li>
                <li><a href="/tai-khoan?tab=xem_donhang"
                        class="<?php echo ($tab == 'xem_donhang' || $tab == 'xem_chitiet') ? 'active' : ''; ?>"><i
                            class="fa-solid fa-box-open"></i> Đơn hàng của bạn</a></li>
                <li><a href="/tai-khoan?tab=change_pass"
                        class="<?php echo ($tab == 'change_pass') ? 'active' : ''; ?>"><i class="fa-solid fa-key"></i>
                        Đổi mật khẩu</a></li>
                <li><a href="/dang-xuat" style="color: #d0011b;"
                        onclick="confirmLink(event, 'Bạn có chắc chắn muốn đăng xuất?', this.href);"><i
                ...
                <?php switch ($tab) {
                    ...
                    case 'change_info': ?>
                        ...
                        <form action="/tai-khoan/cap-nhat-thong-tin" method="POST" class="account-form"
                            onsubmit="confirmForm(event, 'Xác nhận lưu thay đổi?', this);">
                                        ...
                                        foreach ($list_order as $oder) { ?>
                                            <tr>
                                                ...
                                                <td style="color: var(--primary-color); font-weight: bold;">
                                                    <?php echo number_format($oder['tongtien']); ?> đ</td>
                                                ...
                                                <td class="action-btns">
                                                    <a href="/tai-khoan?tab=xem_chitiet&ma_dh=<?php echo $oder['ma_dh']; ?>"
                                                        class="btn-view">Xem</a>
                                                    <?php if ($oder['trangthai'] != 'huy' && $oder['trangthai'] != 'dagiao' && $oder['trangthai'] != 'daxacnhan') { ?>
                                                        <a href="/tai-khoan/huy-don/<?php echo $oder['ma_dh']; ?>"
                                                            onclick="confirmLink(event, 'Hủy đơn hàng này?', this.href);"
                            ...
                            <table class="account-table">
                                ...
                                <tbody>
                                        ...
                                        foreach ($items as $item) { ?>
                                            <tr>
                                                <td style="display: flex; align-items: center; gap: 15px;">
                                                    <img src="/uploads/books/<?php echo $item['link_hinhanh']; ?>"
                                                ...
                                                <td style="color: var(--primary-color); font-weight: bold;">
                                                    <?php echo number_format($item['giasp']); ?> đ</td>
                                    ...
                                    <tr style="background-color: #fafafa;">
                                        ...
                                        <td colspan="2"
                                            style="color: red; font-weight: bold; font-size: 18px; padding-left: 20px;">
